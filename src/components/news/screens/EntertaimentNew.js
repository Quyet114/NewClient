  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={{ fontFamily: FONT.primary, color: COLOR.D, fontSize: 24 }}>Entertaiment News</Text>
...
export default EntertaimentNew
